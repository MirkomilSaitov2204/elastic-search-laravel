...
<div x-data="setup()" x-init="$refs.loading.classList.add('hidden'); setColors(color);" :class="{ 'dark': isDark}">
    <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
        ...
        <div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
            ...
            <main>
                @php
                    $totalCount = $posts->count() + $categories->count() + $tags->count() + $users->count();
                        ...
                        <div class="flex items-center justify-between p-4 bg-white rounded-md dark:bg-darker">
                            <div>
                                ...
                                <span
                                    ...
                                    {{ number_format($posts->count() * 100 / $totalCount, 2, '.', '') }} %
                    </span>
                            </div>
                            <div>
                    <span>
                      ...
                      >
                        ...
                        <div class="flex items-center justify-between p-4 bg-white rounded-md dark:bg-darker">
                            <div>
                                ...
                                <span class="text-xl font-semibold">{{ $tags->count() }}</span>
                                <span
                                    class="inline-block px-2 py-px ml-2 text-xs text-green-500 bg-green-100 rounded-md">
                      {{ number_format($tags->count() * 100 / $totalCount, 2, '.', '') }} %
                    </span>
                            </div>
                            <div>
                    <span>
                      ...
                      >
                        ...
                        <div class="flex items-center justify-between p-4 bg-white rounded-md dark:bg-darker">
                            <div>
                                ...
                                <span class="text-xl font-semibold">{{ $categories->count() }}</span>
                                <span
                                    class="inline-block px-2 py-px ml-2 text-xs text-green-500 bg-green-100 rounded-md">
                      {{ number_format($categories->count() * 100 / $totalCount, 2, '.', '') }} %
                    </span>
                            </div>
                            <div>
                    <span>
                      ...
                      >
                        ...
                        <div class="flex items-center justify-between p-4 bg-white rounded-md dark:bg-darker">
                            <div>
                                ...
                                <span
                                    class="inline-block px-2 py-px ml-2 text-xs text-green-500 bg-green-100 rounded-md">
                      {{ number_format($users->count() * 100 / $totalCount, 2, '.', '') }} %
                    </span>
                            </div>
                            <div>
                    <span>
